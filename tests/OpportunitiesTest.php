...
class OpportunitiesTest extends TestCase
{
    ...
    public function uris_are_generated_correctly()
    {
        ...
        $this->lever->opportunities('250d8f03-738a-4bba-a671-8a3d73477145')->resumes('6a1e4b79-75a3-454f-9417-ea79612b9585')->fetch();
        $this->lever->opportunities('250d8f03-738a-4bba-a671-8a3d73477145')->resumes('6a1e4b79-75a3-454f-9417-ea79612b9585')->download();
        $this->lever->opportunities('250d8f03-738a-4bba-a671-8a3d73477145')->notes()->create([]);
